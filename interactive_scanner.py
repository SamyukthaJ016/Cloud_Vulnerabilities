...
#         with open(creds['service_account_json'], 'r') as f:
#             content = f.read()
#             print("Loaded key length:", len(content))
#             print(content[:200])
...
#             project=credentials.project_id   # 👉 extracted from the JSON file itself
#             )
