...
export const INTEGRATION_TYPES: Record<string, IntegrationType> = {
  ...
  cloudguard: {
    ...
    description: 'Import CloudGuard scan history, findings, and risk candidates into Gigachad GRC',
    ...
    configFields: [
      {
        key: 'baseUrl',
        label: 'CloudGuard Base URL',
        type: 'url',
        required: true,
        placeholder: 'https://cloud-vulnerabilities.vercel.app',
        helpText: 'Public CloudGuard URL that exposes the scan APIs',
      },
      {
        key: 'cloudguardUserId',
        label: 'CloudGuard User ID (Optional)',
        type: 'text',
        required: false,
        placeholder: 'anonymous',
        helpText: 'Used as the cloudguard_user_id cookie for standalone CloudGuard deployments',
      },
      {
        key: 'latestOnly',
        ...
        required: false,
        default: true,
        helpText: 'Only import the newest scan per provider/account',
      },
      {
        key: 'scanLimit',
        label: 'Scan Limit',
        ...
        required: false,
        default: '20',
        helpText: 'Maximum number of latest scans to inspect during sync',
      },
      {
        key: 'findingLimit',
        label: 'Finding Limit',
        ...
        required: false,
        default: '250',
        helpText: 'Maximum number of findings to pull into Gigachad per sync',
      },
    ],
    evidenceTypes: [
      { key: 'scan_history', label: 'Scan History', description: 'Recent CloudGuard scan summaries', defaultEnabled: true },
      { key: 'latest_findings', label: 'Latest Findings', description: 'Normalized findings from the selected scans', defaultEnabled: true },
      { key: 'resources_summary', label: 'Resource Summary', description: 'Resource counts across imported scans', defaultEnabled: true },
      { key: 'risk_candidates', label: 'Risk Candidates', description: 'Critical, high, and medium findings that will create risks', defaultEnabled: true },
    ],
    capabilities: ['evidence_sync', 'risk_creation', 'cloud_security'],
  },
