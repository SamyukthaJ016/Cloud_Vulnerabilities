...
export const INTEGRATION_TYPES = {
  ...
  cloudguard: {
    ...
    description: 'Ingest CloudGuard scan summaries and findings into evidence and risk workflows',
    icon: 'shield',
    iconSlug: 'cloudguard',
    category: 'Cloud Infrastructure',
    apiDocs: '',
    configFields: [
      { key: 'baseUrl', label: 'CloudGuard Base URL', type: 'text', required: true },
      { key: 'cloudguardUserId', label: 'CloudGuard User ID (optional)', type: 'text', required: false },
      { key: 'scanLimit', label: 'Scan Limit', type: 'text', required: false },
      { key: 'findingLimit', label: 'Finding Limit', type: 'text', required: false },
    ],
  },
  aws: {
