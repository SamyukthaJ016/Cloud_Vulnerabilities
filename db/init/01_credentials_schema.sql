...
-- CREATE UNIQUE INDEX IF NOT EXISTS uniq_user_profiles_email
-- ON user_profiles(email);

-- -- ============================================================
-- -- LOGIN AUDIT (OPTIONAL BUT RECOMMENDED)
-- -- ============================================================
...
-- ============================================================================
-- FIX EXISTING NULL EMAILS (REQUIRED BEFORE SET NOT NULL)
-- ============================================================================
UPDATE user_profiles
SET email = 'temp_' || user_id || '@invalid.local'
WHERE email IS NULL;
...
-- Ensure password_hash is never NULL (safe migration)
UPDATE user_profiles
...
-- Case-insensitive unique email for login
DROP INDEX IF EXISTS uniq_user_profiles_email;
...
CREATE INDEX IF NOT EXISTS idx_login_audit_log_created_at
...
VALUES ('anonymous', 'anonymous@cloudguard.local', 'Anonymous User', 'DISABLED')
ON CONFLICT (user_id) DO NOTHING;
