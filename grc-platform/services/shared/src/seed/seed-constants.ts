 ...
 *
 * The values define a stable demo organization and users for local tests.
 *
...
/** Existing demo organization used by seeded data. */
...
/** Existing demo administrator used by seeded data. */
