...
# CloudGuard GRC Platform Module

This folder was merged from the CloudGuard GRC internship handoff repository into the latest CloudGuard scanner project. It should be treated as the governance, risk, compliance, audit, and evidence-review module that sits beside the CloudGuard scanner portal.

CloudGuard remains responsible for scanner jobs, sandbox demos, and evidence ingestion. This GRC module is responsible for compliance workflows, evidence review, risk management, audit reporting, and the CloudGuard connector view.

For the merged project architecture, start with `../docs/grc-platform-merge.md`.

The underlying platform is based on GigaChad GRC.
