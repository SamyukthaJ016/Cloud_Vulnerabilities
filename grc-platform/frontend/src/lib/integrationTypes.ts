...
export const INTEGRATION_TYPES: Record<string, IntegrationType> = {
  cloudguard: {
    name: 'CloudGuard',
    description:
      'Connect CloudGuard scanner output to GRC evidence, risk scoring, audit review, and CERT-In MSME control mapping',
    ...
    configFields: [
      {
        key: 'baseUrl',
        label: 'CloudGuard API URL',
        type: 'url',
        required: true,
        placeholder: 'http://localhost:8000',
        helpText: 'CloudGuard backend or gateway URL',
      },
      {
        key: 'apiToken',
        label: 'Connector API Token',
        type: 'password',
        required: false,
        placeholder: 'Optional token',
        helpText: 'Used when CloudGuard evidence API is protected',
      },
      {
        key: 'framework',
        ...
        required: true,
        default: 'certin_msme',
        options: [{ value: 'certin_msme', label: 'CERT-In MSME Cybersecurity' }],
      },
    ],
    evidenceTypes: [
      {
        ...
        description: 'AWS, GCP, Kubernetes, and IaC findings from CloudGuard scans',
        defaultEnabled: true,
      },
      {
        key: 'mcp_tool_results',
        label: 'MCP Tool Results',
        description: 'Local MCP scanner evidence such as subfinder, httpx, nuclei, nmap, and nikto',
        defaultEnabled: true,
      },
      {
        key: 'confirmed_vulnerabilities',
        label: 'Confirmed Vulnerabilities',
        description: 'CVE-backed vulnerability findings with affected service and remediation',
        defaultEnabled: true,
      },
      {
        key: 'manual_evidence',
        label: 'Manual Evidence',
        description: 'Uploaded screenshots, reports, approvals, and audit proof',
        defaultEnabled: true,
      },
    ],
  },
